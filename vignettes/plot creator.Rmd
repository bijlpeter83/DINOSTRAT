...
```{r}
locations <- read_csv("https://raw.githubusercontent.com/bijlpeter83/DINOSTRAT/1.1/data/Paleolatitude.csv")
locations
```
...
```{r}
modernst <- read_csv("https://raw.githubusercontent.com/bijlpeter83/DINOSTRAT/1.1/data/modernst.csv")
```
#setting a theme
```{r}
theme_set(theme_bw())
```
#selecting input for the maps:
```{r}
...
```{r}
sp_dat <- read_csv("https://raw.githubusercontent.com/bijlpeter83/DINOSTRAT/1.1/data/Dinoevents_Jan21_nov21.csv")
...
```{r}
modernsp <- read_csv("https://raw.githubusercontent.com/bijlpeter83/DINOSTRAT/1.1/data/modernsp.csv")
...
```
#join both datasets into 1, #separate FOs from LOs:
```{r}
...
# first determine how wide the plot shouuld be
