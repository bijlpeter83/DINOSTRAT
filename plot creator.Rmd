...
loc <- getURL("https://raw.githubusercontent.com/bijlpeter83/DINOSTRAT/main/Paleolatitude.csv")
locations <- read.csv(text=loc)
locations <- rename(locations, Source = ï..Source)
locations
...
most <- getURL("https://raw.githubusercontent.com/bijlpeter83/DINOSTRAT/main/modernst.csv")
modernst <- read.csv(text=most)
modernst <- rename(modernst, Source = ï..Source)
modernst
```
```{r}
#setting a theme
...
sp <- getURL("https://raw.githubusercontent.com/bijlpeter83/DINOSTRAT/main/Dinoevents_Jan2021.csv")
sp_dat <- read.csv(text=sp)
sp_dat
...
mosp <- getURL("https://raw.githubusercontent.com/bijlpeter83/DINOSTRAT/main/modernsp.csv")
modernsp <- read.csv(text=mosp)
modernsp <- rename(modernsp, Family=ï..Family)
modernsp
